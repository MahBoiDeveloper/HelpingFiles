: File encoding: UTF-8
: Описание скрипта: редактирование ключа реестра (default) папки "ergc" игры Red Alert 3
: Автор: mah_boi
: Лицензия: MIT
...
: Cкрипт по редактированию ключа реестра "(По умолчанию)" в папке "ergc" для игры Red Alert 3
: Рекомендации:
...
:        - ПутьПоРеестру\Electronic Arts\;
:        - ПутьПоРеестру\Electronic Arts\Electronic Arts\;
:        - ПутьПоРеестру\Electronic Arts\Electronic Arts\Red Alert 3\;
:        - ПутьПоРеестру\Electronic Arts\Electronic Arts\Red Alert 3\ergc.
